        ...
        <div class="carousel-caption d-md-block bloquedetexto ">
          <center>
            <div class="bloquetitulos p-1 p-sm-2 p-md-4 ">
              <h2 class="titulodebanner  ">4-DASI ABU EBO /<br> EL PEZ CANDIL Y EL PEZ LORO </h2>
            ...
            <div class="  w-100 ml-xl-4">
              ...
              <div class=" bg-bloquegunayala p-2  card-text-guna ">
                ...
                <div class="ml-xl-4 p-2 ">
                  ...
                  <div class="card-body">
                    <h3 class="card-title m-0 text-center">DASI ABU EBO </h3>
                    <div class=" mt-3 primeraletra">
                      Ai Abu gwage nuedi. Ai Abu dula ibedi, e dula obgwagwa miledeyobi mergue.
                      Ai Abu aggwadinagan ibedi, yeer dumgue neg ganiggidi.<br>
                      Ibagwengi, ai wargwen ese gornoniggi. Ai wargwen morginnnid yoi, saggan
                      naladiggid se gornoniggi. Ai dasi, Abu asabin wawanmaggwissi sunmaggali: <br>
                      <div class="espacio font-italic bg-gunayala ">-Ai abu, yeer gangu be negsemaid
                        an wisi, na bese gordaniggi. ¡Andi dule wilesa, nabba sadde,
                        uggudba bodi! </div>
                      Yeer dumgu be neg nigga gusiidgine, ¿wis be diggarba an
                      sunna gudigusale?<br>
                      Ai Abu, soladuggin gwisgusunna, gwage nued nigsoggu, Dasi sunmaggedba boed
                      nagase medde. ¡wiles ebinsa guali!<br>
                      <div class="espacio font-italic bg-gunayala"> -¡Degirdi nabirdo , -Abu, Dasi,
                        abin imaged-, be walagwen danisoggu, ibmar sadde be nonibarsoggu,
                        na bega negdi wis daggergebe! ¡Bela an ibmargi be nagguledii gusunno!</div>
                      Dasi, Abu abin idsomagde, yeer iddogedba.
                      <div class="espacio font-italic bg-gunayala"> -¡Emisginsunno!, -goddesunna.</div>
                      Niimar, wis nadebar iddole. Ibagwengi, aggwabisgigan imbaba iba onoleali,
                      gaibirdi ogus iddoleali. Abu, dule nuga niggadsoggu, inna gobega
                      se gollesmoga. Ai abu, bela na e mimmigan bulagwa ibase nae soggarsunna.
                      Bela na ibmar dagnagusmala. Geb, Abu, ai dasise godsa, wegii ga soge:<br>
                      <div class="espacio font-italic bg-gunayala">-Ai Dasi, na mimmigan
                        bulagwa wis iba dagnasoggali; wedi be anga neg edarbedio. Anga neg; be nue
                        aggwo, ise durwiagwar, melle dule baigan anga odogo.<br>
                        -¡Mer buggibbinsae, -ga Dasi soggali-, wegi na bemarga neg daggoe,
                        ibmar agar
                        gudsuli na be dagnonimarbaloe!
                        ¡Bela na be ibmargi bemarga an naggulegoe! </div>
                      ...
                      <div class="espacio font-italic bg-gunayala"> -¡Na bemarga neg nued amisa!
                        ¡Bar anmmar wiledii, neg sadde gwen guosuli! ¡Na bemarga nega dar
                        dummadi amisa!
                      ...
                      Abu mimmigan, ebbinne na aggwadingi dodosmalad geg ie guali, na e nabba
                      medde
                      armalad iesuli.<br>
            ...
            <div class="  w-100 ml-xl-4">
              ...
              <div class=" bg-bloquegunayala p-2  card-text-guna ">
                ...
                <div class="ml-xl-4 p-2 ">
                  ...
                  <div class="card-body">
                    <h3 class="card-title m-0 text-center">EL PEZ CANDIL Y EL PEZ LORO </h3>
                    <div class="mt-3 primeraletra">
                      El señor Abu era un pez muy bueno. Abu tenía una familia tan numerosa como los granos de maíz,
                      y era dueño de extensos y ricos arrecifes.<br>
                      ...
                      <div class="espacio font-italic bg-gunayala"> - Amigo mío, nosotros los Abu salimos a una fiesta.
                        ...
                        - ¡cómo no, -aseguró Dasi-, váyanse tranquilos que aquí no va a pasar nada!
                        ¡Yo les voy a cuidar las cosas!</div>
                      Abu y su familia se marcharon muy felices a la fiesta. Brincaban y
                      carcajeaban entre los arrecifes.
                      Aleteaban y aleteaban muy tranquilos. Chillaban y se empujaban
                      unos a otros con sus aletillas cortas.
                      Dasi los observaba por la ranura de la casa, y cuando el abanico
                      ocultó al último de los chiquillos de Abu, salió corriendo. Dasi salió
                      ...
                      <div class="espacio font-italic bg-gunayala"> - ¡Hermanos míos, les encontré una casa bonita! ¡Ya no seremos más errantes
                        ...
                        sus hermanos.<br>
                        -Los Dasi se prepararon de inmediato.</div>
                      Tomaron sus hamacas, sus tazas,
                      sus platos y otros aperos y corrieron a la nueva casa.<br>
                      Todos los Dasi en hilera invadieron la propiedad de la familia Abu.<br>
                      Pasaron algunos días, para los Abu terminó la fiesta. Felices volvieron
                      ...
                      a ser propiedad de los Dasi. <br>
                      ...
                      Entre los dos se lanzaron palabritas y palabrotas... y el señor Abu vio que ya no podía
                      hacer nada, y se vio presionado abandonar su territorio.<br>
                      Así, la familia Abu empezó a buscar nuevos arrecifes, nuevas tierras para su gente.
                      Los más pequeños se recostaban muy tristes entre las algas y lloraban. Los hijos de
                      ...
                      salían a pasear y no regresaban más.<br>
                      Entonces ...<br>
                      <div class="espacio font-italic bg-gunayala"> -¡Guerra!, - gritaron los Dasi.<br>
                        -¡Guerra!,-respondieron las Abu.<br>
                        Y empezó el ataque y el contraataque. ¡Tac, tac, tac, tac, pum, pum, pum,
