                ...
                <div class="carousel-caption d-md-block bloquedetexto ">
                    <center>
                        <div class="bloquetitulos p-1 p-sm-2 p-md-4 ">
                            <h2 class="titulodebanner  ">1-OLOGWADULE </h2>
            ...
            <div class="  p-3 " id="bloquearticulo">
                        ...
                        <div class="  w-100 ml-xl-4">
                            ...
                            <div class=" bg-bloquegunayala p-2  card-text-guna ">
                                ...
                                <div class="ml-xl-4 p-2 ">
                                    ...
                                    <div class="card-body">
                                        <h3 class="card-title m-0 text-center">OLOGWADULE</h3>
                                        <div class=" mt-3 primeraletra">
                                            ...
                                            dispuso a crear la tierra, Nandummad se dispuso a crear la tierra.<br>
                                            ...
                                            un armazón de plata. <br>

                                            Baba la constituyó así, Nana la constituyó así:<br>
                                            ...
                                            ella seríamos hombres; desde ella nos definimos.<br>
                                            ...
                                            Ellos envolvieron de nuevo el rostro de nana Ologwadule.<br>
                                            ...
                                            juntos cubrían a Ologwadule de oro fino, de plata fina.<br>
                                            ...
                                            de oro amarillo, de plata amarilla. <br>
                ...
                <center>
                    <div class="d-flex flex-wrap mt-2" style="justify-content: center;">
                        ...
                        <a class=" icon-hover actividad   p-2 m-1 " href="./relato2.php" style="text-decoration:none">
                            Siguiente
                ...
                <div>
                    <div class="col-12 card  ">
                        ...
                        <div>
                            <h2 class=" text-center mt-1"> <b> OLOGWADULE <br> ( VIDEO EN VERSIÓN ESPAÑOL) </b> </h2>
                        </div>
